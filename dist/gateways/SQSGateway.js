...
let SQSGateway = class SQSGateway {
    constructor() {
        this.client = new client_sqs_1.SQSClient({ region: "us-east-1" });
    }
    sendMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.client.send(sendMessageCommand);
        });
    }
};
exports.SQSGateway = SQSGateway;
exports.SQSGateway = SQSGateway = __decorate([
